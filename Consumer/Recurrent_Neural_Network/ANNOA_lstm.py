...
class Ozturk:
    ...
    def __create_network(self, hidden_neurons):
        ...
        for i in range(self.__num_hidden_layers):
            self.__model.add(LSTM(shapes['hidden'], return_sequences=i != (self.__num_hidden_layers - 1), name='ANNOA_Hidden_' + str(i + 1)))
    ...
    def __str__(self):
        return 'LSTM_Ozturk_[' + str(self.__size) + ']_[' + ','.join(self.__class_set) + ']'
    ...
    def __set_title(self):
        ...
        return 'LSTM Hidden Layer {}; Size {}; {}; {}; {};'.format(self.__num_hidden_layers, self.__size, classes, data, self.__optimizer)
