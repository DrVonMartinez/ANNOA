...
class OzturkTrain:
    ...
    def __oa_hidden(self, distribution_sequence):
        ...
        u, v = self.__ozturk_function(standardize(train_ozturk, axis=1))
        return u, v
    ...
    def __store_seq(self, oa_producer_df, distribution_sequence):
        oa_producer_df.to_csv(str(distribution_sequence) + ' Data Set ' + str(self.__size) + '.csv_' + self.__theta_distribution, index=False)
